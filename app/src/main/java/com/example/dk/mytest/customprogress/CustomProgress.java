package com.example.dk.mytest.customprogress;
...
public class CustomProgress extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRadius = typeArray.getDimension(R.styleable.CustomProgress_radius, 40);
        mStrokeWidth = typeArray.getDimension(R.styleable.CustomProgress_strokeWidth, 10);
        mCircleColor = typeArray.getColor(R.styleable.CustomProgress_circleColor, Color.BLACK);
        mRingColor = typeArray.getColor(R.styleable.CustomProgress_ringColor, getResources().getColor(R.color.page_color));
        ...
        mBigCircleColor = typeArray.getColor(R.styleable.CustomProgress_bigCircleColor, getResources().getColor(R.color.text_hint_color));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mProgress==0){
            ...
            //显示当前进度（10%这种形式的）
            txt = (int) (mProgress * 1.0f / mTotalProgress * 100) + "%";
        }
